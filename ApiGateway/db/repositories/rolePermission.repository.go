...
func (this *RolePermissionRepository) GetRolePermissionById(id int64) (*models.RolePermission, error) {
...
func (this *RolePermissionRepository) GetRolePermissionByRoleId(roleId int64) ([]*models.RolePermission, error) {
	query := "SELECT id, role_id, permission_id, created_at, updated_at FROM role_permissions WHERE role_id = ?"
	rows, err := this.db.Query(query, roleId)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (this *RolePermissionRepository) AddPermissionToRole(roleId int64, permissionId int64) (*models.RolePermission, error) {
	query := "INSERT INTO role_permissions (role_id, permission_id, created_at, updated_at) VALUES (?, ?, NOW(), NOW())"
	result, err := this.db.Exec(query, roleId, permissionId)
	if err != nil {
		return nil, err
	}
...
func (this *RolePermissionRepository) RemovePermissionFromRole(roleId int64, permissionId int64) error {
...
func (this *RolePermissionRepository) GetAllRolePermissions() ([]*models.RolePermission, error) {
